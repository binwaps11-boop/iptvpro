...
echo "[4/5] build"
cd "$W/$IB"
PKGS="luci luci-proto-ppp ppp-mod-pppoe luci-proto-ipv6 luci-app-commands \
mwan3 luci-app-mwan3 kmod-ath9k kmod-ath10k-ct ath10k-firmware-qca988x-ct \
wpad-basic-mbedtls swconfig iwinfo ip-full kmod-usb2"
