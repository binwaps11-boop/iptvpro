...
object BackendConfig {
     ...
     */
    // المنفذ ٨٠ القياسي (HTTP) — المنافذ غير القياسية مثل ٨٠٩٠ تحجبها بعض
    // مزوّدات الـVPS افتراضياً، فيتعذّر الوصول للخادم من الجوال
    const val LICENSE_SERVER = "http://217.216.59.159"
