(function () {
  ...
  var L = {
    ar: {
      ...
      passwordHint: "اتركها فارغة إذا كان الراوتر بدون كلمة سر", login: "دخول", logout: "خروج",
      ...
      rootPassWarn: "تنبيه أمني: اضبط كلمة مرور root من إدارة النظام، ولا تترك الراوتر بدون كلمة سر.",
    ...
    en: {
      ...
      passwordHint: "Leave empty if the router has no password", login: "Sign in", logout: "Logout",
      ...
      rootPassWarn: "Security notice: set a root password; do not leave the router passwordless.",
